...
function yk_hvno_onclick() {
	if (yk_switch_pic.className != "yk_switch_pic_animation") {
		yk_switch_pic.className = "yk_switch_pic_animation";
		currentNum = 1;
		currentMarginTop = "";
		...
		yk_switch_pic.className = "yk_switch_pic_none";
		clear_timer();
	}
...
function set_timer() {
	timerSwitch=setInterval("timer_switch_pic()",17100);
}
